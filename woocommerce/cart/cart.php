...
<div class="container">
	<div id="cart">
		...
		<div class="row">
			<div class="col-md-8 boxCart">
				<h2 class='secure'><span><i class='fal fa-lock'></i> Pagamento seguro</span><?php esc_attr_e( 'Cart', 'woocommerce' ); ?></h2>
				<form class="woocommerce-cart-form pt-2" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
...
<?php if ( wc_coupons_enabled() ) { ?>
			...
			<div class="col-md-4">
				...
				<div class='others'>
					<a href="<?php echo get_permalink( woocommerce_get_page_id( 'shop' ) );?>" class='btn btn-neutral'><i class='fal fa-angle-left'></i> Continuar a comprar</a>
				</div>
			</div>
		</div>
	</div>
